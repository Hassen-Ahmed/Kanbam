...
describe("ButtonAccount component", () => {
  //
  test("It has elements with text Light and Dark", () => {
    render(
  ...
  //
  test("It will NOT call themeSetter func if there is NO click event happend to LIGHT theme button", async () => {
    //
